            ...
            <div class="preview-container">
                <div id="y-chat-container">
                    <div id="y-chat-header" >
                        <div class="y-header-wrapper y-header-type-1" :style="styleList('header')" :class="{ 'active' : current === 'header' }" @click.stop="changeCurrent('header')">
                    ...
                    <div id="y-chat-main" :style="styleList('main')" :class="{ 'active' : current === 'main' }" @click.stop="changeCurrent('main')">
                        <div class="y-main-wrapper" >
                            <div class="y-pop-wrap y-pop-left" :class="{ 'active' : current === 'left' }" @click.stop="changeCurrent('left')">
                            ...
                            <div class="y-pop-wrap y-pop-right" :class="{ 'active' : current === 'right' }" @click.stop="changeCurrent('right')">
                    ...
                    <div id="y-chat-footer">
                        <div class="y-footer-wrapper y-footer-type-1">
                            ...
                            <div class="y-footer-recode-wrap" :style="styleList('footer')" :class="{ 'active' : current === 'footer' }" @click.stop="changeCurrent('footer')">
                        ...
                        <div class="edit-content" >
                            <template v-if="current === 'header'">
                                ...
                                <el-form-item class="label-input-color" label="标题">
                                    ...
                                    <el-color-picker class="label-input-right" v-model="getSetting.header.color"></el-color-picker>
                                </el-form-item>
                                <el-form-item class="label-input-color" label="电话">
                                    <el-input class="label-input" v-model="getSetting.header.telNumber"></el-input>
                                    <el-switch class="label-input-right" v-model="getSetting.header.showTelNumber"></el-switch>
                                </el-form-item>
                            ...
                            <template v-else-if="current === 'left'">
                                ...
                                <el-form-item class="label-input-color" label="头像">
                                    <el-input class="label-input" placeholder="不输入将使用默认值" v-model="getSetting.left.avatar"></el-input>
                                    <el-switch class="label-input-right" v-model="getSetting.left.showAvatar"></el-switch>
                                </el-form-item>
                            ...
                            <template v-else-if="current === 'right'">
                                ...
                                <el-form-item class="label-input-color" label="名称">
                                    ...
                                    <el-switch class="label-input-right" v-model="getSetting.right.showName"></el-switch>
                                </el-form-item>
                                <el-form-item class="label-input-color" label="头像">
                                    <el-input class="label-input" placeholder="不输入将使用默认值" v-model="getSetting.right.avatar"></el-input>
                                    <el-switch class="label-input-right" v-model="getSetting.right.showAvatar"></el-switch>
                                </el-form-item>
                                <el-form-item class="label-input-color" label="文字颜色">
                            ...
                            <template v-else-if="current === 'form'">
                                ...
                                <el-form-item class="label-input-color" label="input栅格">
                                    <el-input-number v-model="getSetting.form.inputSpan" :min="1" :max="20"></el-input-number>
                                </el-form-item>
                                ...
                                <el-form-item class="label-input-color" label="按钮栅格">
                                    <el-input-number v-model="getSetting.form.buttonSpan" :min="1" :max="20"></el-input-number>
                                </el-form-item>
                                <el-form-item class="label-input-color" label="按钮">
                                    <el-input class="label-input" v-model="getSetting.form.btnText"></el-input>
                                    <el-color-picker class="label-input-right" v-model="getSetting.form.btnColor"></el-color-picker>
                                </el-form-item>
                            ...
                            <template  v-else-if="current === 'footer'">
                                <el-form-item class="label-input-color" label="文字">
                                    ...
                                    <el-color-picker class="label-input-right" v-model="getSetting.footer.color"></el-color-picker>
                                </el-form-item>
                                <el-form-item class="label-input-color" label="背景颜色">
